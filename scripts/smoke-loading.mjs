...
const historyChunk = chunkFile('src/screens/HistoryScreen.tsx');
...
try {
  ...
  try {
    ...
    check('intent', 'pointerdown sem click não navega', new URL(page.url()).pathname.replace(/\/$/, '').endsWith('/assessment'));
